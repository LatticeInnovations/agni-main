...
- API `GET` `/{{api_endpoint}}/vaccine/manufacturer`
```json
    {
    "status": 1,
...
- API `POST` `/{{api_endpoint}}/Immunization`
- **Request**
```json
[
    {
...
- API `GET` `/{{api_endpoint}}/Immunization`
- Parameter - patientId=id1,id2
- Example - `{{api_endpoint}}/Immunization?patientId=6642,6644&_count=5000`
- **Request**
```json
{
    "status": 1,
